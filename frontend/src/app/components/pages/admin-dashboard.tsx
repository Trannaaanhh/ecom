      ...
      {!data ? (
        ...
        <div className="space-y-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="rounded-lg border border-border p-4"><p className="text-xs text-muted-foreground">Đơn hàng mới</p><p className="text-xl font-semibold mt-1">{data.kpis.new_orders}</p></div>
          ...
          <section className="rounded-lg border border-border overflow-hidden">
            <div className="px-4 py-3 border-b border-border font-medium">Đơn hàng gần đây</div>
