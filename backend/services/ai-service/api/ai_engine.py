...
FALLBACK_PRODUCTS = [
    {
        "product_id": "101",
        "name": "Laptop Gaming Orion 15",
        "price": 21990000,
        "category_id": "laptop",
        "category_name": "Laptop & Máy tính",
        "description": "Laptop gaming hiệu năng cao, phù hợp chiến game và đồ họa.",
    },
    {
        "product_id": "102",
        "name": "Laptop Văn Phòng Nova 14",
        "price": 14990000,
        "category_id": "laptop",
        "category_name": "Laptop & Máy tính",
        "description": "Laptop mỏng nhẹ cho học tập, văn phòng và làm việc di động.",
    },
    {
        "product_id": "205",
        "name": "Tai nghe Bluetooth Pulse X",
        "price": 1290000,
        "category_id": "accessories",
        "category_name": "Phụ kiện",
        "description": "Tai nghe không dây có chống ồn nhẹ và pin dài.",
    },
    {
        "product_id": "310",
        "name": "Chuột không dây Flow M",
        "price": 490000,
        "category_id": "accessories",
        "category_name": "Phụ kiện",
        "description": "Chuột không dây nhỏ gọn, phù hợp văn phòng và laptop.",
    },
    {
        "product_id": "411",
        "name": "Điện thoại Zenith 6.7",
        "price": 18990000,
        "category_id": "phone",
        "category_name": "Điện thoại & Phụ kiện",
        "description": "Điện thoại flagship với màn hình lớn và camera chụp đêm tốt.",
    },
    {
        "product_id": "512",
        "name": "Bàn phím cơ Titan RGB",
        "price": 1590000,
        "category_id": "accessories",
        "category_name": "Phụ kiện",
        "description": "Bàn phím cơ cho game thủ và dân lập trình thích gõ sướng tay.",
    },
]
